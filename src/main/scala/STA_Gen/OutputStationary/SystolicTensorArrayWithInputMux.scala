...
object SystolicTensorArrayWithInputMux extends App {
  ChiselStage.emitSystemVerilog(
    gen = new SystolicTensorArrayWithInputMux(16,16,1,1,1, 64),
    firtoolOpts = Array("--verilog", "-o=Os_Sta_16x16x1x1x1_syn.v", "-disable-all-randomization", "-strip-debug-info", "--lowering-options=disallowPackedArrays")
  )
  ChiselStage.emitSystemVerilog(
    gen = new SystolicTensorArrayWithInputMux(8, 8, 2, 2, 1, 64),
    firtoolOpts = Array("--verilog", "-o=Os_Sta_8x8x2x2x1_syn.v", "-disable-all-randomization", "-strip-debug-info", "--lowering-options=disallowPackedArrays")
  )
  ChiselStage.emitSystemVerilog(
    gen = new SystolicTensorArrayWithInputMux(4, 4, 4, 4, 1, 64),
    firtoolOpts = Array("--verilog", "-o=Os_Sta_4x4x4x4x1_syn.v", "-disable-all-randomization", "-strip-debug-info", "--lowering-options=disallowPackedArrays")
  )
  ChiselStage.emitSystemVerilog(
    gen = new SystolicTensorArrayWithInputMux(8, 8, 1, 1, 4, 64),
    firtoolOpts = Array("--verilog", "-o=Os_Sta_8x8x1x1x4_syn.v", "-disable-all-randomization", "-strip-debug-info", "--lowering-options=disallowPackedArrays")
  )
  ChiselStage.emitSystemVerilog(
    gen = new SystolicTensorArrayWithInputMux(4, 4, 2, 2, 4, 64),
    firtoolOpts = Array("--verilog", "-o=Os_Sta_4x4x2x2x4_syn.v", "-disable-all-randomization", "-strip-debug-info", "--lowering-options=disallowPackedArrays")
  )
  ChiselStage.emitSystemVerilog(
    gen = new SystolicTensorArrayWithInputMux(2, 2, 4, 4, 4, 64),
    firtoolOpts = Array("--verilog", "-o=Os_Sta_2x2x4x4x4_syn.v", "-disable-all-randomization", "-strip-debug-info", "--lowering-options=disallowPackedArrays")
  )
  ChiselStage.emitSystemVerilog(
    gen = new SystolicTensorArrayWithInputMux(4, 4, 1, 1, 16, 64),
    firtoolOpts = Array("--verilog", "-o=Os_Sta_4x4x1x1x16_syn.v", "-disable-all-randomization", "-strip-debug-info", "--lowering-options=disallowPackedArrays")
  )
  ChiselStage.emitSystemVerilog(
    gen = new SystolicTensorArrayWithInputMux(2, 2, 2, 2, 16, 64),
    firtoolOpts = Array("--verilog", "-o=Os_Sta_2x2x2x2x16_syn.v", "-disable-all-randomization", "-strip-debug-info", "--lowering-options=disallowPackedArrays")
  )
  ChiselStage.emitSystemVerilog(
    gen = new SystolicTensorArrayWithInputMux(1, 1, 4, 4, 16, 64),
    firtoolOpts = Array("--verilog", "-o=Os_Sta_1x1x4x4x16_syn.v", "-disable-all-randomization", "-strip-debug-info", "--lowering-options=disallowPackedArrays")
  )
}
